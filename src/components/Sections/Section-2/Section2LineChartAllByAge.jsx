...
const Section2LineChartAllByAge = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTime(jsonData.weeklyVacAgeWiseReport.map((item) => item.label));
        setTotalDoses(
          jsonData.weeklyVacAgeWiseReport.map((item) => item.total)
        );
        setTwelveTo14(
          jsonData.weeklyVacAgeWiseReport.map((item) => item.vac_12_14)
        );
        setFifteenTo17(
          jsonData.weeklyVacAgeWiseReport.map((item) => item.vac_15_17)
        );
        setEighteenTo44(
          jsonData.weeklyVacAgeWiseReport.map((item) => item.vac_18_45)
        );
        setFortyfiveTo60(
          jsonData.weeklyVacAgeWiseReport.map((item) => item.vac_45_60)
        );
        setAbove60(
          jsonData.weeklyVacAgeWiseReport.map((item) => item.vac_60_above)
        );
      } catch (error) {
...
export default Section2LineChartAllByAge;
