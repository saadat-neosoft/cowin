  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTime(
          jsonData.vaccinationDoneByTimeAgeWise.map((item) => {
        ...
        setTotalDoses(
          jsonData.vaccinationDoneByTimeAgeWise.map((item) => item.total)
        );
        setTwelveTo14(
          jsonData.vaccinationDoneByTimeAgeWise.map((item) => item.vac_12_14)
        );
        setFifteenTo17(
          jsonData.vaccinationDoneByTimeAgeWise.map((item) => item.vac_15_17)
        );
        setEighteenTo44(
          jsonData.vaccinationDoneByTimeAgeWise.map((item) => item.vac_18_45)
        );
        setFortyfiveTo60(
          jsonData.vaccinationDoneByTimeAgeWise.map((item) => item.vac_45_60)
        );
        setAbove60(
          jsonData.vaccinationDoneByTimeAgeWise.map((item) => item.vac_60_above)
        );
      } catch (error) {
