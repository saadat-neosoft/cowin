  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTime(
          jsonData.regReportData.map((item) => {
        ...
        setTotalDoses(jsonData.regReportData.map((item) => item.total));
        setTwelveTo14(jsonData.regReportData.map((item) => item.age12));
        setFifteenTo17(jsonData.regReportData.map((item) => item.age15));
        setEighteenTo44(jsonData.regReportData.map((item) => item.age18));
        setFortyfiveTo60(jsonData.regReportData.map((item) => item.age45));
        setAbove60(jsonData.regReportData.map((item) => item.age60));
      } catch (error) {
