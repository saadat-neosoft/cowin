...
const Section5LineChartAllByAge = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTime(jsonData.regWeekReportData.map((item) => item.label));
        setTotalDoses(jsonData.regWeekReportData.map((item) => item.total));
        setTwelveTo14(jsonData.regWeekReportData.map((item) => item.age12));
        setFifteenTo17(jsonData.regWeekReportData.map((item) => item.age15));
        setEighteenTo44(jsonData.regWeekReportData.map((item) => item.age18));
        setFortyfiveTo60(jsonData.regWeekReportData.map((item) => item.age45));
        setAbove60(jsonData.regWeekReportData.map((item) => item.age60));
      } catch (error) {
...
export default Section5LineChartAllByAge;
